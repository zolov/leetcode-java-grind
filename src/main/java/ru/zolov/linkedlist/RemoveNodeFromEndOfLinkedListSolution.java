...
public class RemoveNodeFromEndOfLinkedListSolution {
    ...
    public static ListNode removeNthFromEnd(ListNode head, int n) {
        // Создаем фиктивный узел в начале листа для того чтобы можно было использовать быстрый и медленный указатель
        ...
        while (n > 0) {
            ...
            // уменьшаем N
            n--;
            // Тем самым создавая разрыв между левым и правым указателем для использования быстрого и медленного указателя
        }
    ...
    public static void main(String[] args) {
        ...
        var listNode1 = new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, new ListNode(5, null)))));
        System.out.println(nodeToString(listNode1));
        System.out.println(nodeToString(removeNthFromEnd(listNode1, 2)));


        System.out.println("#2");
        var listNode2 = new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, new ListNode(5, new ListNode(6, new ListNode(7, new ListNode(8, null))))))));
